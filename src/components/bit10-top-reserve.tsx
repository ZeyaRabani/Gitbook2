...
export async function BIT10TopReserves() {
                ...
                {tokensWithPercentages.map((token) => (
                    ...
                    >
                        ...
                        <td className='py-2 px-6 text-right font-mono'>
                            {formatPreciseDecimal(token.noOfTokens)}
                        </td>
                        <td className='py-2 px-6 text-right font-medium'>
                            ${formatPreciseDecimal(token.price * token.noOfTokens)}
                        </td>
