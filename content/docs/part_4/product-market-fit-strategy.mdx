...
<ImageZoom src='https://raw.githubusercontent.com/ZeyaRabani/Gitbook2/main/public/assets/index.png' alt='Index Coop' className='rounded border' width={444} height={113} />
