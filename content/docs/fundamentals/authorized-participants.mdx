...
<Callout title='TL;DR'>An Authorized participants (APs) is an individual who provids liquidity to back up the index funds on BIT10.</Callout>
...
You can become an AP through Instant Liquidity Provider (ILP). You can swap assets instantly and earn rewards, there is no lock-up time, or no fees. We will airdrop the incentive to the users drectly.

#### Staked Liquidity Providers

Another way you can become an AP is through Staked Liquidity Providers (SLP). You need to stake you asset for some duration to earn incentive for the Staked asset. The incentive for SLP is divided based on the staked quantity. The more you stake the more incentive you will recive.
