...
You can visit [testnet.bit10.app/faucet](https://testnet.bit10.app/faucet) to request BIT10.BTC tokens. Users need to enter their email and the Principal ID of their wallet.
